...
<picture>
  ...
  <img src="./assets/generated/hero-static-light.svg" alt="Zhiyuan's Living Memory Lab: reliable AI, auditable agents, and knowledge infrastructure" width="100%" />
</picture>
...
<picture>
  ...
  <img src="./assets/generated/chronicle-light.svg" alt="Chronicle Memory turns photos and notes into a private, traceable personal journal" width="100%" />
</picture>
</td>
</tr>
</table>
...
<table><tr>
<td width="33%" valign="top"><strong>Reliable AI</strong><br/><sub>Retrieved evidence, semantic geometry, and feedback-driven checks for low-confidence outputs.</sub></td>
<td width="33%" valign="top"><strong>Auditable Agents</strong><br/><sub>Goals, permissions, evidence, and acceptance criteria expressed as workflow contracts.</sub></td>
<td width="33%" valign="top"><strong>Knowledge Infrastructure</strong><br/><sub>Notes, experiments, projects, and decisions organized into systems that can keep growing.</sub></td>
</tr></table>
...
<details>
<summary><strong>🧪 Open my lab — research questions, public work, and live metrics</strong></summary>
...
<p align="center">
  <img src="./assets/snapshots/metrics.svg" alt="Daily public GitHub metrics snapshot" width="92%" />
</p>

</details>

<details>
<summary><strong>🎮 Play with my GitHub — memory shard, alter ego, and contribution snake</strong></summary>

### PUBLIC MEMORY SHARD · 2026

> A useful memory should preserve the path back to what actually happened.
>
> <sub>Chronicle Memory design note</sub>
...
<picture>
  ...
  <img alt="Zhiyuan's contribution graph animated as a snake" src="https://raw.githubusercontent.com/h0ll0w-AkuZr0guY/h0ll0w-AkuZr0guY/gh-pages/github-contribution-grid-snake.svg" width="100%" />
</picture>

</details>

<details>
<summary><strong>🛠️ Remix this profile — config, modules, and safe defaults</strong></summary>
...
<sub>Built as a small, forkable profile engine. Public data may update automatically; private Chronicle data never enters this repository.</sub>
